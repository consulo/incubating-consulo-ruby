=begin
 ...
 Created on Fri Dec 07 14:12:27 +0300 2007 by IntelliJ IDEA Ruby Plugin.
=end
...
module Zlib
    ...
    class GzipFile < Object
        ...
        #    
        def self.wrap(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
        public
        #   
    ...
    class GzipWriter < Zlib::GzipFile
        ...
        #    Same as IO.
        #    
        def printf(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
        public
        #   
        ...
        #    Same as IO.
        #    
        def print(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
        public
        #   
        ...
        #    Same as IO.
        #    
        def puts(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
    end
    #   
    ...
    class GzipReader < Zlib::GzipFile
        ...
        #    
        def read(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
        public
        #   
        ...
        #    See Zlib::GzipReader documentation for a description.
        #    
        def gets(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
        public
        #   
        #    See Zlib::GzipReader documentation for a description.
        #    
        def readline(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
        public
        #   
        #    See Zlib::GzipReader documentation for a description.
        #    
        def each(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
        public
        #   
        #    See Zlib::GzipReader documentation for a description.
        #    
        def each_line(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
        public
        #   
        #    See Zlib::GzipReader documentation for a description.
        #    
        def readlines(*smth) #paramteres couldn`t be extracted
            #This is a stub, used for indexing
        end
    end
    #   
