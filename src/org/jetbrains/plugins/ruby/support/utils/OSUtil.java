...
public class OSUtil
{
	...
	private static final String[] SVN_CMD_ARGS = new String[]{
			"svn",
			"help"
	};
	...
	{
		final GeneralCommandLine cmdLine = Runner.createAndSetupCmdLine(null, null, null, null, true, SVN_CMD_ARGS[0], SVN_CMD_ARGS[1]);
		try
		{
