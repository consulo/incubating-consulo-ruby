...
public abstract class BaseRailsFacetType<F extends BaseRailsFacet> extends FacetType<F, BaseRailsFacetConfiguration>
{
	...
	protected BaseRailsFacetType(@NotNull final FacetTypeId<F> baseRailsFacetFacetTypeId, @NotNull final String stringId, @Nullable final FacetTypeId underlyingFacetType)
	{
	...
	public void registerDetectors(@NotNull final FacetDetectorRegistry<BaseRailsFacetConfiguration> registry)
	{
		...
		{
			public BaseRailsFacetConfiguration detectFacet(final VirtualFile environmentFile, final Collection<BaseRailsFacetConfiguration> existentFacetConfigurations)
			{
	...
	private BaseRailsFacetConfiguration detectFacet(@NotNull final VirtualFile bootFile, final Collection<BaseRailsFacetConfiguration> existentFacetConfigurations)
	{
