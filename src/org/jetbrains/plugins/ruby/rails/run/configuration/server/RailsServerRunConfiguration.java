...
public class RailsServerRunConfiguration extends RubyRunConfiguration implements RailsServerRunConfigurationParams {
    ...
    @NotNull private String myServerType = DEFAULT_SERVER;
    @NotNull private RailsEnvironmentType myEnvironmentType = RailsEnvironmentType.DEVELOPMENT;
    private String myPort = TextUtil.EMPTY_STRING;
    private String myIP = TextUtil.EMPTY_STRING;

    public RailsServerRunConfiguration(final Project project, final ConfigurationFactory factory,
                                   final String name) {
    ...
    public static void copyParams(final RailsServerRunConfigurationParams fromParams,
                                  final RailsServerRunConfigurationParams toParams) {
    ...
    private void inspectPort(final boolean isExecution) throws Exception {
        if (isChoosePortManually()) {
            ...
            checkNumberFormat(isExecution, port_str, false,
                              "run.configuration.script.port.bad.format");
    ...
    private void checkNumberFormat(final boolean isExecution,
                               final String port_str, final boolean isByte,
    ...
    private void checkPoint(final boolean isExecution,
                            final String port_str) throws Exception {
        if (port_str.equals(".")) {
            return;
        }
