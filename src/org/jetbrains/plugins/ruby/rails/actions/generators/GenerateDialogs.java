...
public class GenerateDialogs {
    protected static class GenerateActionDialog extends GenerateDialog {
        ...
        public GenerateActionDialog(final Module module, final String title,
                                        final ActionInputValidator validator) {
    ...
    protected static class GenerateControllerDialog extends GenerateDialog {
        ...
        public GenerateControllerDialog(final Module module, final String title,
                                        final ControllerInputValidator validator) {
            super(module, title, validator);
        }
    ...
    protected static class GenerateDialog extends DialogWrapper {
        ...
        public GenerateDialog(@NotNull final Module module, final String title,
                              final SimpleGeneratorInputValidator validator) {
        ...
        protected void doOKAction() {
            ...
            if (myValidator == null) {
                ...
                if (myValidator.checkInput(mainArgument)
                        && myValidator.canClose(generatorArgs)) {
                    close(OK_EXIT_CODE);
        ...
        protected void doHelpAction() {
            ...
            final String title =
                    RBundle.message("dialog.generate.common.help.title",
                                    myValidator.getGeneratorAction().getGeneratorName());

            showGeneratorHelpDialog(myModule.getProject(),
                                    title,
                                    helpData.get());
        }
        ...
        private void readHelpData() {
            final String title =
                    RBundle.message("progress.dialog.generate.common.help.wait.title");
            ...
            helpData.set(RubyScriptRunner.runRubyScript(sdk, myModule.getProject(),
                                                        GeneratorsUtil.GENERATE_SCRIPT, workingDir,
                                                        new Runner.ModalProgressMode(title), false, null, name));
        }
    }
    ...
    protected static class GeneratorHelpDialog extends DialogWrapper {
        ...
        public GeneratorHelpDialog(final Project project, final String title,
                                   final Output output) {
            super(project, false);
            myOutput = output;
            initDialog(title);
    ...
    public static int showGenerateActionDialog(final Module module,
                                               final String title,
                                               final ActionInputValidator validator) {
        int result;
        ...
        if (application.isUnitTestMode() || application.isHeadlessEnvironment()) {
            ...
            final GenerateActionDialog dialog =
                    new GenerateActionDialog(module, title, validator);
            dialog.show();
    ...
    @SuppressWarnings({"UnusedReturnValue"})
    public static int showGenerateControllerDialog(final Module module,
                                                   final String title,
                                                   final ControllerInputValidator validator) {
        int result;
        final Application application = ApplicationManager.getApplication();
        if (application.isUnitTestMode() || application.isHeadlessEnvironment()) {
          ...
          GenerateControllerDialog dialog =
                  new GenerateControllerDialog(module, title, validator);
          dialog.show();
          result = dialog.getExitCode();
        }
        return result;
    ...
    @SuppressWarnings({"UnusedReturnValue"})
    public static int showGenerateDialog(final Module module,
                                         final String title,
                                         final SimpleGeneratorInputValidator validator) {
        int result;
        final Application application = ApplicationManager.getApplication();
    ...
    @SuppressWarnings({"UnusedReturnValue"})
    public static int showGeneratorHelpDialog(final Project project,
                                              final String title,
                                              final Output output) {
        int result;
        final Application application = ApplicationManager.getApplication();
