...
public class GeneratorsUtil {
    ...
    public static String[] getInstalledGenerators(@Nullable final Project project,
        ...
        if (output != null) {
            ...
            try {
                if (!TextUtil.isEmpty(output.getStderr())) {
                    final String msg = RBundle.message("execution.ruby.script.get.available.generators",
                            output.getStderr());
        ...
        if (!exceptions.isEmpty()) {
            ...
            ExecutionHelper.showErrors(project,
                                       exceptions,
                                       RBundle.message("execution.error.title.generators.list", moduleName),
                                       url);
        }
        return generators;
    }
    ...
    public static Output getGenerateScriptOutput(@Nullable final Project project,
        ...
        try {
            return RubyScriptRunner.runRubyScript(sdk, project, GENERATE_SCRIPT, workingDir,
                                                  new Runner.SameThreadMode(), showStdErrErrors, null);
        } catch (Exception exp) {
            exceptions.add(exp);
            return null;
        }
     ...
     */
    public static boolean existsNewerThanTimeStamp(@Nullable final VirtualFile file,
                                                   final long ts) {
        if (file == null) {
            return false;
        }
    ...
    public static SerializableGenerator findGenerator(final String name, final boolean isGroup,
    ...
    public static void initOptionsCheckBoxes(@NotNull final JCheckBox pretendCheckBox,
                                             @NotNull final JCheckBox forceCheckBox,
                                             @NotNull final JCheckBox skipCheckBox,
                                             @NotNull final JCheckBox backtraceCheckBox,
                                             @NotNull final JCheckBox svnCheckBox,
                                             @NotNull final GeneratorOptions options) {
    ...
    public static void saveSettings(@NotNull final JCheckBox pretendCheckBox,
                                    @NotNull final JCheckBox forceCheckBox,
                                    @NotNull final JCheckBox skipCheckBox,
                                    @NotNull final JCheckBox backtraceCheckBox,
                                    @NotNull final JCheckBox svnCheckBox,
    ...
    public static String calcGeneralOptionsString(@NotNull final JCheckBox backtraceCheckBox,
                                                  @NotNull final JCheckBox forceCheckBox,
                                                  @NotNull final JCheckBox pretendCheckBox,
                                                  @NotNull final JCheckBox skipCheckBox,
                                                  @NotNull final JCheckBox svnCheckBox) {
    ...
    public static void invokeGenerator(final Module uncommitedModule,
        ...
        try {
            ...
            final RubyScriptRunnerArgumentsProvider provider =
                    new RubyScriptRunnerArgumentsProvider(scriptParameters, null, null);

            RailsScriptRunner.runRailsScriptInCosole(
                    sdk, uncommitedModule, listener,
                    new Filter[]{new RFileLinksFilter(uncommitedModule),
