...
public class RakeTaskNodeInfo extends NodeInfo<RakeTaskSerializableImpl> {
    ...
    public static RakeTaskNodeInfo createTaskNode(@NotNull final String name,
                                                  @NotNull final RakeTaskSerializableImpl parentTask,
        ...
        if (isGroup) {
            return new RakeTaskNodeInfo(RailsIcons.RAILS_FOLDER_OPENED, RailsIcons.RAILS_FOLDER_CLOSED,
                                        task, true);
        }
    ...
    private RakeTaskNodeInfo(final Icon icon, final RakeTaskSerializableImpl task, final boolean isGroup) {
        this(icon, icon, task, isGroup);
    }
    private RakeTaskNodeInfo(final Icon openIcon, final Icon closedIcon, final RakeTaskSerializableImpl task, final boolean isGroup) {
