...
public class ViewsConventions {
    ...
    public static boolean isRHTMLOrRJSViewFile(@NotNull final RVirtualFile rFile,
    ...
    public static boolean containsViewsByViewsFolder(@Nullable VirtualFile viewsFolder,
    ...
    @NotNull
    public static List<VirtualFile> getLayouts(@Nullable final String controllerDirUrl,
    ...
    @Nullable
    public static VirtualFile getViewsFolder(@Nullable final VirtualFile controller,
                                             @NotNull final Module module) {
        // supports rails 2.0 views
        if (controller == null
            || RailsConstants.APPLICATION_NAME.equals(controller.getNameWithoutExtension())) {
            return null;
        }
        ...
        final VirtualFile file = ControllersConventions.getControllerDependentFile(parent.getUrl(), module,
                                                           ControllersConventions.getControllerName(controller),
                                                           RailsConstants.VIEWS_PATH);
...
//    }
    ...
    @NotNull
    public static List<VirtualFile> getViews(@NotNull final RVirtualMethod method,
                                             @NotNull final String controllerDirUrl,
                                             @NotNull final String controllerName,
                                             @NotNull final Module module) {

        final String actionName = method.getName();
        final String url
                = ControllersConventions.getControllerDependentFileUrl(controllerDirUrl, module,
                                                                       controllerName,
                                                                       RailsConstants.VIEWS_PATH);
    ...
    @NotNull
    public static List<VirtualFile> getPartialViews(@NotNull final String controllerDirUrl,
                                                    @NotNull final String controllerName,
                                                    @NotNull final Module module) {
    ...
    protected static List<VirtualFile> findViewsInFolder(final @NotNull String actionName, 
    ...
    protected static List<VirtualFile> findLayoutsInFolder(final @NotNull String controllerName,
                                                           final @Nullable String url) {
        final VirtualFileManager vFManager = VirtualFileManager.getInstance();
        final List<VirtualFile> viewsUrls = new ArrayList<VirtualFile>();
        if (url != null) {
    ...
    @Nullable
    public static String getRelativePathOfLayoutsFolder(@Nullable final String fileUrl,
                                                        @NotNull final Module module) {
        // supports rails 2.0 views
        final StandardRailsPaths railsPaths = RailsFacetUtil.getRailsAppPaths(module);
        assert railsPaths != null; //Not null for modules with Rails Support
    ...
    @Nullable
    public static String getRelativePathOfViewsFolder(@Nullable final String fileUrl,
                                                      @NotNull final Module module) {
        // supports rails 2.0 views
        final StandardRailsPaths railsPaths = RailsFacetUtil.getRailsAppPaths(module);
        assert railsPaths != null; //Not null for modules with Rails Support
     ...
     */
    public static boolean hasValidTemplatePath(@NotNull final String viewFileUrl,
                                               @NotNull final StandardRailsPaths settings) {
        // supports rails 2.0 views
    ...
    public static boolean isApplicationLayoutFile(final VirtualFile layout) {
        // supports rails 2.0 views
        return RailsConstants.APPLICATION_NAME.equals(getActionMethodNameByView(layout))
                && isLayoutFile(layout);
    }
    ...
    public static boolean isViewFile(@Nullable final VirtualFile fileOrDir) {
        ...
        return !(fileOrDir == null || fileOrDir.isDirectory()) &&
                isValidViewFileName(fileOrDir.getName());
    }

    public static boolean isLayoutFile(@Nullable final VirtualFile fileOrDir) {
        // supports rails 2.0 views
        return !(fileOrDir == null || fileOrDir.isDirectory()) &&
                isValidLayoutFileName(fileOrDir.getName());
    }

    @Nullable
    public static RVirtualClass getControllerByView(@NotNull final VirtualFile viewFile,
                                                    @NotNull final Module moduleWithRails) {
        // supports rails 2.0 views
        ...
        final String controllerUrl =
                ControllersConventions.getControllerUrlByViewUrl(viewFile.getUrl(), railsPaths);
        final VirtualFile controllerFile = VirtualFileManager.getInstance().findFileByUrl(controllerUrl);
        if (controllerFile == null) {
            return null;
        }
        final RFileInfo rInfo =
                RubyModuleCachesManager.getInstance(moduleWithRails).getFilesCache().getUp2DateFileInfo(controllerFile);
        if (rInfo == null)  {
            return null;
        }
     ...
     */
    @Nullable
    public static VirtualFile getViewsFolderByClass(@NotNull final Module module,
                                                    @NotNull final RClass rClass) {
        ...
        if (rClassParentContainer == null
                || !(rClassParentContainer instanceof RFile || rClassParentContainer instanceof RModule)) {
            return null;
        }
        ...
        return getViewsFolder(rClass.getContainingFile().getVirtualFile(),
                                               module);
    }
}
