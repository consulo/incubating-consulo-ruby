...
public class ControllersConventions {
    ...
    public static boolean isControllerFile(@NotNull final RVirtualFile rFile,
    ...
    public static boolean isControllerFile(@NotNull final RVirtualFile rFile,
        ...
        if (!fileName.endsWith(RailsConstants.CONTROLLERS_FILE_NAME_SUFFIX)
            && !RailsConstants.APPLICATION_NAME.equals(fileName.toLowerCase())) {
            return false;
        }
    ...
    public static String getControllerName(@NotNull final String controllerFileName) {
        ...
        return name.substring(0,
                              name.length() - RailsConstants.CONTROLLERS_FILE_NAME_SUFFIX.length());
    }
    ...
    public static String getControllerClassNameByHelper(@NotNull final RVirtualModule helperModule) {
        ...
        return moduleName.substring(0, moduleName.length() - RailsConstants.HELPERS_MODULE_NAME_SUFFIX.length())
               + RailsConstants.CONTROLLERS_CLASS_NAME_SUFFIX;
    }
    ...
    public static String getControllerNameByClassName(@Nullable final String className) {
        ...
        return name.substring(0,
                              name.length() - RailsConstants.CONTROLLERS_CLASS_NAME_SUFFIX.length() - 1);
    }
    ...
    public static String getControllerNameByHelperFileName(@Nullable final String fileName) {
        ...
        return fileName.substring(0,
                                   fileName.length() - RailsConstants.HELPERS_FILE_NAME_SUFFIX.length());
    }
    ...
    public static boolean isApplicationControllerFile(@NotNull final VirtualFile controller,
                                                      final Module module) {
        return isApplicationControllerFile(controller.getUrl(),
                                           controller.getNameWithoutExtension(),
                                           module);
    }

    public static boolean isApplicationControllerFile(@NotNull final String fileUrl,
                                                      @NotNull final String fileNameWOExt,
                                                      final Module module) {
        /**
         * Check for file name is used only for optimization
         */
        return RailsConstants.APPLICATION_NAME.equals(fileNameWOExt)
               && fileUrl.equals(getApplicationControllerUrl(module));
    }
    ...
    public static String getApplicationControllerUrl(final Module module) {
        ...
        return root + VirtualFileUtil.VFS_PATH_SEPARATOR
                + RailsConstants.APPLICATION_NAME + "."
     ...
     */
    @Nullable
    public static String getControllerDependentFileUrl(@NotNull final String controllerDirUrl,
     ...
     */
    @Nullable
    public static VirtualFile getControllerDependentFile(final String controllerDirUrl,
                                                         final Module module,
                                                         final String fileName,
                                                         final String pathPrefix) {

        final String url =
                getControllerDependentFileUrl(controllerDirUrl, module, fileName, pathPrefix);
        return url != null ? VirtualFileManager.getInstance().findFileByUrl(url)
                           : null;
    }
     ...
     */
    @Nullable
    public static String getControllerFullName(@NotNull final Module module,
                                               @NotNull final VirtualFile controllerFile) {
    ...
    public static boolean isControllerClass(@Nullable final RVirtualClass rClass,
                                            @NotNull final Module module) {
        if (!RailsFacetUtil.hasRailsSupport(module)
            || getControllerNameByClassName(rClass) == null) {
            return false;
        }
     ...
     */
    @Nullable
    public static String getControllerCorrespondingDir(@NotNull final String dirUrl,
                                                       @NotNull final Module module) {
        if (!RailsFacetUtil.hasRailsSupport(module)) {
            return null;
        }
    ...
    @Nullable
    public static String getControllerURL(final String helperDirUrl,
     ...
     * @throws StringIndexOutOfBoundsException if file isn't in templates folder.
     * At first you should check <code>hasValidTemplatePath()</code>.
     */
    @NotNull
    public static String getControllerUrlByViewUrl(@NotNull final String viewFileUrl,
                                                   @NotNull final StandardRailsPaths railsPaths) {
        // supports rails 2.0 views
        return getControllerUrlByViewUrl(viewFileUrl,
                                         railsPaths.getViewsRootURL(),
                                         railsPaths.getControllerRootURL());
    }
     ...
     */
    @NotNull
    public static String getControllerUrlByViewsFolderUrl(@NotNull final String folderUrl,
                                                          @NotNull final StandardRailsPaths railsPaths) {
    ...
    @NotNull
    public static String getControllerUrlByViewUrl(@NotNull final String viewFileUrl,
                                                   @NotNull final String viewsRootUrl,
                                                   @NotNull final String controllersRootUrl) {
        // supports rails 2.0 views
        final StringBuilder buff = new StringBuilder();
        buff.append(controllersRootUrl);
    ...
    private static RClass getControllerClass(final Module module, final VirtualFile controllerFile) {
        ...
        return RContainerUtil.getClassByName((RFile)psiFile,
                        getControllerClassNameByFileName(controllerFile.getName()));
    }
    ...
    public static RMethod getActionByViewFile(final PsiFile file, final Module module) {
        ...
        return (RMethod)RVirtualPsiUtil.getMethodWithoutArgumentsByName(controllerClass,
                                                              ViewsConventions.getActionMethodNameByView(viewFile));
    }
...
//               && method.getAccessModifier().equals(AccessModifier.PUBLIC); //TODO
    ...
    @Nullable
    public static String getRelativePathOfControllerFolder(@NotNull final String fileUrl,
                                                           @NotNull final Module module) {
        final StandardRailsPaths settings = RailsFacetUtil.getRailsAppPaths(module);
        assert settings != null;
        final String root = settings.getControllerRootURL();
    ...
    @Nullable
    public static RClass getControllerClassByShortName(@NotNull final Module module,
