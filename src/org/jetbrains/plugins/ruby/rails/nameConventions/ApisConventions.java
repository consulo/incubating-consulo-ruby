...
public class ApisConventions {
    ...
    public static boolean isApisFile(@NotNull final RVirtualFile rFile,
                                     @Nullable final Module module) {
        return isWebServiceApiFile(rFile, module, RContainerUtil.getTopLevelClasses(rFile));
    }

    public static boolean isWebServiceApiFile(@NotNull final RVirtualFile rFile,
                                              @Nullable final Module module,
    ...
    public static boolean isApiWebServiceClass(@Nullable final RVirtualClass rClass,
        ...
        */
        ...
        return (path.size() == 3
                && ApisConventions.ACTION_WEB_SERVICE_MODULE.equals(path.get(0)))
                && ApisConventions.API_MODULE.equals(path.get(1))
                && ApisConventions.BASE_CLASS.equals(path.get(2));
    }}
