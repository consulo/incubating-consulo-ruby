...
public class RHTMLIndentProcessor {
    @NotNull
    public static Indent calcHTMLIndentForChild(@NotNull final ASTNode parentNode,
                                                @NotNull final XmlFormattingPolicy fPolicy) {
        return Indent.getSpaceIndent(calcHTMLIndentSize(parentNode, fPolicy));
    }

    @NotNull
    public static Indent calcRHTMLIndentForChild(@Nullable final RCompoundStatement childRCmpSt,
                                                 @Nullable final RCompoundStatement parentRCmpSt,
                                                 @Nullable final ASTNode parentNode,
                                                 @NotNull final XmlFormattingPolicy fPolicy,
                                                 final boolean addHtmlIndent) {
    ...
    public static Indent calcRubyIndentForNode(@Nullable final RCompoundStatement childRCmpSt,
                                               @Nullable final RCompoundStatement parentRCmpSt,
    ...
    public static int calcRubyIndentSize(@Nullable final RCompoundStatement childRCmpSt,
                                          @Nullable final RCompoundStatement parentRCmpSt,
                                          @NotNull final CodeStyleSettings settings) {
