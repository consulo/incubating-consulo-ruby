...
public class RHTMLBlockGenerator {
    ...
    public static List<Block> createRHTMLSubBlocks(@NotNull final ASTNode node,
                                                   final XmlFormattingPolicy xmlPolicy,
                                                   final RHTMLBlock rhtmlBlock,
                                                   @NotNull final FileViewProvider provider) {
        ...
        if (node instanceof CompositeElement) {
            ...
            while (childNode != null) {
                if (RHTMLFormatterUtil.canBeCorrectBlock(childNode)) {
                    childNodeInfo = processContentChildNode(childNode, childNodeInfo,
                                                            node, subBlocks, nodeRCmpSt,
                                                            xmlPolicy, provider, nodeBoundsTRange, null, null);
                } else {
    ...
    @NotNull
    public static NodeInfo processContentChildNode(@NotNull final ASTNode childNode,
                                                   @NotNull final NodeInfo info,
                                                   final ASTNode parentNode,
                                                   final List<Block> subBlocks,
                                                   final RCompoundStatement nodeRCmpSt,
                                                   final XmlFormattingPolicy xmlPolicy,
                                                   @NotNull final FileViewProvider fileViewProvider,
                                                   @NotNull final TextRange parentNodeTextRange,
                                                   @Nullable final Alignment alignment,
                                                   @Nullable final Indent rhtmlIndentIfWasCalculated) { //Null if wan;t calced yet
        ...
        final RCompoundStatement childRCmpSt =
                RHTMLFormatterUtil.getParentRCmpStByRHTMLOrHTMLChildNode(fileViewProvider, childNode);
        final Indent indent = rhtmlIndentIfWasCalculated != null
                ? rhtmlIndentIfWasCalculated
                : RHTMLIndentProcessor.calcRHTMLIndentForChild(childRCmpSt, nodeRCmpSt, parentNode, xmlPolicy, true);

        if (childNodeType == RHTMLTokenType.TEMPLATE_CHARACTERS_IN_RHTML) {
            return processHTMLTemplateData(childNode,
                                           childTextRange, parentNode,
                                           subBlocks, indent, alignment, xmlPolicy, childRCmpSt,
                                           parentNodeTextRange, fileViewProvider);
        }
        
        //rhtml tag for injection
        else if (childNodeType == RHTMLElementType.RHTML_XML_TAG
                || childNodeType == RHTMLTokenTypeEx.RHTML_INJECTION_IN_HTML) {
            ...
            final Indent commentIndent = shouldIgnoreIndent
    ...
    private static TextRange getHTMLBoundsInRCmpSt(@NotNull final RCompoundStatement st,
        ...
        if (startRubyCodeInRHTML == null) {
            ...
            final RHTMLRubyInjectionTag startInjection = (RHTMLRubyInjectionTag) ((startRubyCodeInRHTML instanceof RHTMLRubyInjectionTag)
                    ? startRubyCodeInRHTML
                    : RHTMLRubyInjectionTagNavigator.getByPsiElement(startRubyCodeInRHTML));
        ...
        if (endRubyCodeInRHTML == null) {
            ...
            final RHTMLRubyInjectionTag enInjectionTag = (RHTMLRubyInjectionTag) ((endRubyCodeInRHTML instanceof RHTMLRubyInjectionTag)
                            ? endRubyCodeInRHTML
                            : RHTMLRubyInjectionTagNavigator.getByPsiElement(endRubyCodeInRHTML));
    ...
    @NotNull
    public static NodeInfo processHTMLTemplateData(final ASTNode templateNode,
                                                   @NotNull final TextRange templateRange,
                                                   @NotNull final ASTNode parentNode,
                                                   @NotNull final List<Block> subBlocks,
                                                   @NotNull final Indent indent,
                                                   @Nullable final Alignment alignment,
                                                   @NotNull final XmlFormattingPolicy xmlPolicy,
                                                   @Nullable final RCompoundStatement childRCmpSt,
                                                   @NotNull final TextRange parentNodeTextRange,
                                                   @NotNull final FileViewProvider vProvider) {
        ...
        if (RHTMLFormatterUtil.canBeCorrectBlock(htmlPsiNode)) {
            ...
            if (RHTMLFormatterUtil.containsTextRange(boundsTRange, htmlPsiTRange)) {
                //contains whole
                if (isTag || RHTMLFormatterUtil.isTagOrAttrElementOrAttrValue(htmlPsi)
                          || isJSEmbeddedContent) {
                    ...
                    if (RHTMLFormatterUtil.containsTextRange(templateRange, htmlPsiTRange)) {
                        ...
                        final RCompoundStatement htmlPsiEndRCmpSt =
                                RHTMLFormatterUtil.getParentRCmpStByRHTMLOrHTMLChildNode(vProvider, htmlPsiEndNode);
                        ...
                        if (childRCmpSt != htmlPsiEndRCmpSt) {
                            ...
                            nextPsi = rhtmlForHtmlCmpStEnd != null
                                        ? RHTMLRubyInjectionTagNavigator.getByPsiElement(rhtmlForHtmlCmpStEnd)
                                        : null;
                        ...
                        final TextRange nextNodeTRange = nextHtmlNode == null
                                ? null
                                : (RHTMLFormatterUtil.safelyCreateTextRange(htmlPsiEndOffset, htmlEndInRHTMLEnd));
                ...
                if (htmlPsi instanceof XmlTag || isJSEmbeddedContent) {
                    ...
                    final PsiElement endRubyElementCodeInRHTML =
                            RHTMLFormatterUtil.findRHTMLElementByStartOffset(vProvider, childRCmpStEndOffset, true);
                    ...
                    if (endRubyElementCodeInRHTML == null) {
                        ...
                        final RHTMLRubyInjectionTag injectionTag =
                                RHTMLRubyInjectionTagNavigator.getByPsiElement(endRubyElementCodeInRHTML);
        ...
        if (htmlPsiEndOffset < templateRangeEnd) {
            ...
            final TextRange nextNodeTRange = nextHtmlNode == null
                    ? null
                    : (RHTMLFormatterUtil.safelyCreateTextRange(htmlPsiEndOffset, templateRangeEnd));
    ...
    private static void createAnotherLanguageBlockWrapper(final Language childLanguage,
                                                             final ASTNode child,
        ...
        result.add(new ForeignLanguageBlock(child, policy,
                                            childModel.getRootBlock(),
                                            indent, 0, child.getTextRange()));
    }

    private static void createAndAddRHTMLHtml(final boolean isTag,
                                              final XmlFormattingPolicy xmlPolicy,
        ...
        if (textRange != null) {
            ...
            while (lastElemInTRange != null
                    && tRangeStart <= lastElemInTRangeOffset
                    && !RHTMLFormatterUtil.canBeCorrectBlock(lastElemInTRange.getNode())) {
        ...
        final Block block = isTag
                ? new RHTMLHtmlTagBlock(node, wrap, alignment, xmlPolicy, indent, provider, textRangeWithoutTrailingWhiteSpaces)
                : new RHTMLHtmlBlock(node, wrap, alignment, xmlPolicy, indent, provider, textRangeWithoutTrailingWhiteSpaces);
        subBlocks.add(block);
    }

    private static void createAndAddUnClosedRHtml(final boolean isTag,
                                                     final List<Block> subBlocks,
                                                     final XmlFormattingPolicy xmlPolicy,
                                                     final TextRange boundsTRange,
                                                     final PsiElement htmlPsi,
                                                     final TextRange htmlPsiTRange,
                                                     final Indent indent,
                                                     final Alignment alignment,
                                                     final FileViewProvider provider) {
        ...
        final TextRange tagBounds = new TextRange(htmlPsiTRange.getStartOffset(),
                boundsTRange.getEndOffset());
        createAndAddRHTMLHtml(isTag, xmlPolicy, htmlPsi, subBlocks, tagBounds, indent, alignment, provider);
    }

    @NotNull
    private static RHTMLNodeInfo processRHTMLInjectionTag(@NotNull final ASTNode rhtmlTagNode,
                                                          final ASTNode parentNode,
                                                          @NotNull final List<Block> blockList,
                                                          @NotNull final Indent indent,
                                                          @Nullable final Alignment alignment,
                                                          @NotNull final XmlFormattingPolicy xmlPolicy,
                                                          final RCompoundStatement parentNodeRCmpSt, 
