 ...
 * @date: Aug 30, 2007
 */
public class HtmlInRHTMLReferenceProvider extends HtmlReferenceProvider {
    protected boolean isSuitableFile(PsiFile file) {
        return file.getFileType() == RHTMLFileType.RHTML;
    }
}
