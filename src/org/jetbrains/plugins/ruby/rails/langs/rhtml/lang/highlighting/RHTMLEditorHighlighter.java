...
public class RHTMLEditorHighlighter extends LayeredLexerEditorHighlighter {
    ...
    public RHTMLEditorHighlighter(final EditorColorsScheme scheme,
        ...
        super(RHTMLFileType.RHTML.getHighlighter(project, file), scheme);

        myProject = project;
        myFile = file;

        final SyntaxHighlighter rubyHighlighter =
                RubyLanguage.RUBY.getSyntaxHighlighter(project, file);
    ...
    protected boolean updateLayers() {
        ...
        if (!Comparing.equal(myTemplateLanguage, templateLanguage)) {
            ...
            final SyntaxHighlighter templateLanguageHighlighter = myTemplateLanguage.getSyntaxHighlighter(myProject, myFile);
