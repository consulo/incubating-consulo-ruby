...
public class RHTMLRubyInjectionBlock extends RHTMLBlock {
    ...
    public RHTMLRubyInjectionBlock(@NotNull final ASTNode node,
                                   @Nullable final Indent indent, @Nullable final Wrap wrap,
                                   @NotNull final XmlFormattingPolicy xmlFormattingPolicy,
                                   @Nullable final Alignment alignment,
                                   @Nullable final ASTNode parentNode,
                                   @Nullable final RCompoundStatement parentRCmpSt) {
    ...
    protected List<Block> buildChildren() {
        ...
        while (childNode != null) {
            if (RHTMLFormatterUtil.canBeCorrectBlock(childNode)) {
                ...
                if (RHTMLTokenType.RHTML_SEPARATORS.contains(childNodeType)
                        || childNodeType == RHTMLTokenType.OMIT_NEW_LINE) {
    ...
    public static void processRubyCodeCharacters(final List<Block> subBlocks,
                                           final ASTNode node,
                                           final XmlFormattingPolicy xmlPolicy,
                                           final Alignment childrenAlignment,
                                           final Indent childrenIndent) {
        ...
        while (curRuby != null && curRuby.getParent() != null
                && curRuby.getParent().getTextRange().getStartOffset() == startOffset) {
