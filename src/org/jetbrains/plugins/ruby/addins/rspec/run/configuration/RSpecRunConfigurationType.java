...
public class RSpecRunConfigurationType  implements LocatableConfigurationType {
    ...
    public static RSpecRunConfigurationType getInstance() {
        return ApplicationManager.getApplication().getComponent(RSpecRunConfigurationType.class);
    }
    ...
    public String getComponentName() {
        return RComponents.RSPEC_RUN_CONFIGURATION_TYPE;
    }
...
// if not in psi file
    ...
    private RunnerAndConfigurationSettings createRunRSpecScriptTestsConf(final Project project, final VirtualFile file, final String name) {
        ...
        final RunnerAndConfigurationSettings settings
                = RunManager.getInstance(project).createRunConfiguration(name, myRSpecTestsFactory);
    ...
    public boolean isConfigurationByElement(final RunConfiguration configuration,
    ...
    private RunnerAndConfigurationSettings createRunAllSpecsInFolderConf(@NotNull final PsiDirectory psiDirectory) {
         ...
         if (module == null
             ...
             || !RSpecModuleSettings.getInstance(module).shouldUseRSpecTestFramework()) {
