...
public class RVirtualUtil {
    ...
    public static void addVirtualFields(RVirtualContainer container, RFieldHolder holder) {
        ...
        if (container instanceof RVirtualClass){
            ((RVirtualClassImpl)container).setVirtualFields(fields);
        } else
        if (container instanceof RVirtualObjectClass){
    ...
    public static List<RVirtualField> getVirtualFields(@NotNull final RVirtualContainer container,
    ...
    public static void addVirtualConstants(@NotNull final RVirtualContainer container,
                                           @NotNull final RConstantHolder holder) {
    ...
    public static void addVirtualGlobalVars(@NotNull final RVirtualContainer container,
                                            @NotNull final RGlobalVarHolder holder) {
    ...
    private static void gatherAllStructuralElementRec(@NotNull final RVirtualStructuralElement element,
                                                      @NotNull final ArrayList<RVirtualStructuralElement> list) {
        list.add(element);
