...
public class RubyEnterHandler extends EditorWriteActionHandler implements RubyTokenTypes
{
	...
	private static final TokenSet STRING_LIKE_TOKENS = TokenSet.orSet(BNF.tSTRING_LIKE_CONTENTS, BNF.tEXPR_SUBT_TOKENS, BNF.tESCAPE_SEQUENCES);

	private static final TokenSet NO_INDENT_AFTER = TokenSet.orSet(STRING_LIKE_TOKENS, TokenSet.create(tBLOCK_COMMENT_BEGIN, tBLOCK_COMMENT_CONTENT));
