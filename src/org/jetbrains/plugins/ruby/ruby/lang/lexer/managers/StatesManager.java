...
import org.jetbrains.plugins.ruby.ruby.lang.lexer.managers.state.*;
...
////// InDEF ///////////////////////////////////////////////////////////////////////////////////////////////////////////
            if (isInDefState()){
                ...
                if (BNF.tTERM_TOKENS.contains(type)){
                    setInDef(false);
                    setExpr(Expr.BEG);
                    return;
                } else
                if (BNF.tLPARENS.contains(type)){
                    defParensBalance++;
                } else
                if (type == tRPAREN){
...
////// ExpArg //////////////////////////////////////////////////////////////////////////////////////////////////////////
            if (getExpr() == Expr.BEG &&
                    (type == kRETURN || type == kYIELD || type == kSUPER || type == kRESCUE || type == kDEFINED) ||
