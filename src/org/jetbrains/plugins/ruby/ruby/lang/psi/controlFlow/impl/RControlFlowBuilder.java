...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public Instruction[] buildControlFlow(@Nullable final FileSymbol fileSymbol,
                                          @NotNull final RPsiElement scope,
                                          @Nullable final RPsiElement startInScope,
                                          @Nullable final RPsiElement endInScope) {
    ...
    public void visitRIdentifier(final RIdentifier rIdentifier) {
        ...
        if (rIdentifier.isParameter() || rIdentifier.isLocalVariable()) {
            ReadWriteInstructionImpl instruction =
                    new ReadWriteInstructionImpl(rIdentifier.getName(), myInstructionNumber++, UsageAnalyzer.createUsageAccess(rIdentifier));
            addNode(instruction);
            checkPending(instruction);
        }
    }
