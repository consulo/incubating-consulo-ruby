...
// defaults
     ...
     * @return Icon
     */
    public static Icon getIcon(final PsiElement element) {
        if (element instanceof RFile){
...
// For global variables
    ...
    public static void replaceInParent(@NotNull final PsiElement oldElement,
                                       @NotNull final PsiElement ... newElements) {
    ...
    public static void addBeforeInParent(@NotNull final PsiElement anchor,
                                         @NotNull final PsiElement ... newElements) {
    ...
    public static RPsiElement getStatement(PsiElement element) {
      ...
      while (statement != null &&
             (statement.getParent() instanceof RExpressionInParens || statement.getParent() instanceof RExpressionSubstitution));
