...
public class RFileUtil {
    ...
    @NotNull
    public static List<String> getUrlsByRPsiElement(@NotNull final FileSymbol fileSymbol,
                                                    @NotNull final RVirtualFile file,
                                                    final boolean relativeToDirectory,
                                                    @NotNull final RPsiElement requirement) {
...
// 'some_path'+'some_path'
        if (requirement instanceof RBinaryExpression &&
                ((RBinaryExpression) requirement).getOperationType() == RubyTokenTypes.tPLUS){
...
// File.expand_path(File.dirname(__FILE__) + ..)
    ...
    @NotNull
    public static List<String> findUrlsForName(@NotNull final FileSymbol fileSymbol,
    ...
    public static List<String> findUrlsForName(@NotNull final FileSymbol fileSymbol,
                                               @Nullable final String content,
                                               @Nullable final RVirtualFile file) {
    ...
    @NotNull
    private static List<String> findUrlsForFileName(@NotNull final FileSymbol fileSymbol,
                                                    @Nullable final RVirtualFile file,
                                                    @NotNull String name,
                                                    final boolean relativeToDirectory) {
        final ArrayList<String> urls = new ArrayList<String>();
    ...
    private static boolean isSimpleString(PsiElement requirement) {
        return requirement instanceof RBaseString &&
                ((RBaseString) requirement).getExpressionSubstitutions().size()==0;
    }
...
// Add own directory
    ...
    @NotNull
    public static List<String> getAvailableRequiresUrls(@NotNull final FileSymbol fileSymbol,
    ...
    private static List<String> getRelativeUrls(@NotNull final RubyFilesCache[] caches,
                                                @NotNull final VirtualFile file,
                                                boolean onlyDirectoryFiles) {
