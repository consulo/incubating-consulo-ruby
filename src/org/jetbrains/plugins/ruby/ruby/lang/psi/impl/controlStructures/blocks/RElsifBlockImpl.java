 ...
 * Date: 16.06.2006
 */
public class RElsifBlockImpl extends RConditionalStatementImpl implements RElsifBlock {
    public RElsifBlockImpl(ASTNode astNode) {
        super(astNode);
    }

    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof RubyElementVisitor) {
            ((RubyElementVisitor)visitor).visitRElsifBlock(this);
            return;
        }
