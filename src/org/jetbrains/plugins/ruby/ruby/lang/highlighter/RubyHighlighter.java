...
//Intension
    ...
    public static final TextAttributesKey HEREDOC_ID = TextAttributesKey.createTextAttributesKey(
            HEREDOC_ID_ID,
            HEREDOC_ID_DEFAULT_ATTRS
    );
    public static final TextAttributesKey NUMBER = TextAttributesKey.createTextAttributesKey(
            NUMBER_ID,
            NUMBER_DEFAULT_ATTRS
    );
    public static final TextAttributesKey STRING = TextAttributesKey.createTextAttributesKey(
            STRING_ID,
            STRING_DEFAULT_ATTRS
    );
    public static final TextAttributesKey ESCAPE_SEQUENCE = TextAttributesKey.createTextAttributesKey(
            ESCAPE_SEQUENCE_ID,
            ESCAPE_SEQUENCE_DEFAULT_ATTRS
    );
    public static final TextAttributesKey INVALID_ESCAPE_SEQUENCE = TextAttributesKey.createTextAttributesKey(
            INVALID_ESCAPE_SEQUENCE_ID,
            INVALID_ESCAPE_SEQUENCE_DEFAULT_ATTRS
    );
    public static final TextAttributesKey OPERATION_SIGN = TextAttributesKey.createTextAttributesKey(
            OPERATION_SIGN_ID,
            OPERATION_SIGN_DEFAULT_ATTRS
    );
    public static final TextAttributesKey BRACKETS = TextAttributesKey.createTextAttributesKey(
            BRACKETS_ID,
            BRACKETS_DEFAULT_ATTRS
    );
    public static final TextAttributesKey EXPR_SUBST_MARKS = TextAttributesKey.createTextAttributesKey(
            EXPR_IN_STRING_ID,
            EXPR_SUBST_MARKS_DEFAULT_ATTRS
    );
    public static final TextAttributesKey BAD_CHARACTER = TextAttributesKey.createTextAttributesKey(
            BAD_CHARACTER_ID,
            BAD_CHARACTER_DEFAULT_ATTRS
    );
    public static final TextAttributesKey REGEXPS = TextAttributesKey.createTextAttributesKey(
            REGEXP_ID,
            REGEXP_DEFAULT_ATTRS
    );
    public static final TextAttributesKey WORDS = TextAttributesKey.createTextAttributesKey(
            WORDS_ID,
            WORDS_DEFAULT_ATTRS
    );
    public static final TextAttributesKey HEREDOC_CONTENT = TextAttributesKey.createTextAttributesKey(
            HEREDOC_CONTENT_ID,
    ...
    public static final TextAttributesKey IDENTIFIER = TextAttributesKey.createTextAttributesKey(
            IDENTIFIER_ID,
            IDENTIFIER_DEFAULT_ATTRS
    );
    public static final TextAttributesKey CONSTANT = TextAttributesKey.createTextAttributesKey(
            CONSTANT_ID,
            CONSTANT_DEFAULT_ATTRS
    );
    public static final TextAttributesKey GVAR = TextAttributesKey.createTextAttributesKey(
            GVAR_ID,
            GVAR_DEFAULT_ATTRS
    );
    public static final TextAttributesKey CVAR = TextAttributesKey.createTextAttributesKey(
            CVAR_ID,
            CVAR_DEFAULT_ATTRS
    );
    public static final TextAttributesKey IVAR = TextAttributesKey.createTextAttributesKey(
            IVAR_ID,
            IVAR_DEFAULT_ATTRS
    );
    public static final TextAttributesKey NTH_REF = TextAttributesKey.createTextAttributesKey(
            NTH_REF_ID,
            NTH_REF_DEFAULT_ATTRS
    );
    public static final TextAttributesKey BACK_REF = TextAttributesKey.createTextAttributesKey(
            BACK_REF_ID,
            BACK_REF_DEFAULT_ATTRS
    );
    ...
    public static final TextAttributesKey SEMICOLON = TextAttributesKey.createTextAttributesKey(
            SEMICOLON_ID,
            SEMICOLON_DEFAULT_ATTRS
    );

    public static final TextAttributesKey HASH_ASSOC = TextAttributesKey.createTextAttributesKey(
            HASH_ASSOC_ID,
            HASH_ASSOC_DEFAULT_ATTRS
    );
    public static final TextAttributesKey LINE_CONTINUATION = TextAttributesKey.createTextAttributesKey(
            LINE_CONTINUATION_ID,
            LINE_CONTINUATION_DEFAULT_ATTRS
    );


    // Additional syntax
    public static final TextAttributesKey CONSTANT_DEF = TextAttributesKey.createTextAttributesKey(
            CONSTANT_DEF_ID,
            CONSTANT_DEF_DEFAULT_ATTRS
    );
    public static final TextAttributesKey LOCAL_VARIABLE = TextAttributesKey.createTextAttributesKey(
            LOCAL_VARIABLE_ID,
            LOCAL_VARIABLE_DEFAULT_ATTRS
    );
    public static final TextAttributesKey SYMBOL = TextAttributesKey.createTextAttributesKey(
            SYMBOL_ID,
            SYMBOL_DEFAULT_ATTRS
    );

    public static final TextAttributesKey REQUIRE_OR_LOAD_CALL = TextAttributesKey.createTextAttributesKey(
            REQUIRE_OR_LOAD_CALL_ID,
            REQUIRE_OR_LOAD_CALL_DEFAULT_ATTRS
    );
    public static final TextAttributesKey REQUIRE_OR_LOAD_CALL_ARG = TextAttributesKey.createTextAttributesKey(
            REQUIRE_OR_LOAD_CALL_ARG_ID,
            REQUIRE_OR_LOAD_CALL_ARG_DEFAULT_ATTRS
    );

    public static final TextAttributesKey INCLUDE_OR_EXTEND_CALL = TextAttributesKey.createTextAttributesKey(
            INCLUDE_OR_EXTEND_CALL_ID,
            INCLUDE_OR_EXTEND_CALL_DEFAULT_ATTRS
    );
    public static final TextAttributesKey PRIVATE_CALL = TextAttributesKey.createTextAttributesKey(
            PRIVATE_CALL_ID,
            PRIVATE_CALL_DEFAULT_ATTRS
    );
    public static final TextAttributesKey PROTECTED_CALL = TextAttributesKey.createTextAttributesKey(
            PROTECTED_CALL_ID,
            PROTECTED_CALL_DEFAULT_ATTRS
    );
    public static final TextAttributesKey PUBLIC_CALL = TextAttributesKey.createTextAttributesKey(
            PUBLIC_CALL_ID,
            PUBLIC_CALL_DEFAULT_ATTRS
    );
    public static final TextAttributesKey INCLUDE_JAVA_CALL = TextAttributesKey.createTextAttributesKey(
            INCLUDE_JAVA_CALL_ID,
            INCLUDE_JAVA_CALL_DEFAULT_ATTRS
    );
    public static final TextAttributesKey ATTR_READER = TextAttributesKey.createTextAttributesKey(
            ATTR_READER_CALL_ID,
            ATTR_READER_DEFAULT_ATTRS
    );
    public static final TextAttributesKey ATTR_WRITER = TextAttributesKey.createTextAttributesKey(
            ATTR_WRITER_CALL_ID,
            ATTR_WRITER_DEFAULT_ATTRS
    );
    public static final TextAttributesKey ATTR_ACCESSOR = TextAttributesKey.createTextAttributesKey(
            ATTR_ACCESSOR_CALL_ID,
            ATTR_ACCESSOR_DEFAULT_ATTRS
    );
    public static final TextAttributesKey RAILS_ATTR = TextAttributesKey.createTextAttributesKey(
            RAILS_ATTR_CALL_ID,
            RAILS_ATTR_DEFAULT_ATTRS
    );
    public static final TextAttributesKey REQUIRE_GEM_CALL = TextAttributesKey.createTextAttributesKey(
            REQUIRE_GEM_CALL_ID,
            REQUIRE_GEM_CALL_DEFAULT_ATTRS
    );
//Intentions
    public static final TextAttributesKey INSPECTION_MULTIPLE_RESOLVE_WARNING = TextAttributesKey.createTextAttributesKey(
            INSPECTION_MULTIPLE_RESOLVE_WARNING_ID,
            INSPECTION_MULTIPLE_RESOLVE_WARNING_DEFAULT_ATTRS
    );
}
