...
public class RubyFoldingBuilder implements FoldingBuilder {
    ...
    private static final TokenSet FOLDED_ELEMENTS = TokenSet.create(
            RubyElementTypes.MODULE,
            RubyElementTypes.CLASS,
            RubyElementTypes.OBJECT_CLASS,
            RubyElementTypes.METHOD,
            RubyElementTypes.SINGLETON_METHOD,

            RubyElementTypes.HEREDOC_VALUE,

            RubyElementTypes.DO_CODE_BLOCK,
            RubyElementTypes.BRACE_CODE_BLOCK,

            RubyTokenTypes.tEND_MARKER,

            RubyElementTypes.IF_STATEMENT,
            RubyElementTypes.UNLESS_STATEMENT,
            RubyElementTypes.WHILE_STATEMENT,
            RubyElementTypes.BEGIN_END_BLOCK_STATEMENT,
            RubyElementTypes.LBEGIN_STATEMENT,
    ...
    private void gatherDescriptors(@NotNull final ASTNode node, @NotNull final List<FoldingDescriptor> descriptors) {
        ...
        for (ASTNode child : node.getChildren(null)) {  //TODO OuterElements
