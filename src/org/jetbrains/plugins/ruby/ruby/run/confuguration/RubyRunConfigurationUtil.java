...
public class RubyRunConfigurationUtil {
    ...
    public static void inspectWorkingDirectory(final AbstractRubyRunConfiguration conf,
    ...
    public static void inspectModule(final AbstractRubyRunConfiguration conf,
                                     final boolean isExecution) throws Exception {
        // Module inspection
    ...
    public static void throwExecutionOrRuntimeException(final String msg,
                                                        final boolean isExecution) throws Exception {
        if (isExecution) {
...
//        }
    ...
    public static boolean isConfigurationByElement(final RunConfiguration configuration,
