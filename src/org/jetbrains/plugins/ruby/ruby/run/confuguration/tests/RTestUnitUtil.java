...
public class RTestUnitUtil {
     ...
     */
    public static boolean isUserUnitTestCase(@NotNull final Symbol rVClassSymbol,
    ...
    public static boolean isBaseUnitTestCase(@NotNull final Symbol rVClassSymbol) {
        ...
        if (Comparing.equal(RailsConstants.TEST_CASE_CLASS_NAME, name)) {
            ...
            if (unitModuleSymbol != null &&
                    Comparing.equal(RailsConstants.UNIT_MODULE_NAME, unitModuleSymbol.getName())) {

                final Symbol testUnitModuleSymb = unitModuleSymbol.getParentSymbol();
                return testUnitModuleSymb != null &&
                        Comparing.equal(RailsConstants.TEST_MODULE_NAME, testUnitModuleSymb.getName());
            }
        }
        return false;
    }
     ...
     */
    public static boolean isClassUnitTestCase(@NotNull final RVirtualClass rClass,
    ...
    public static boolean hasValidTestNameAndNotSingleton(@NotNull final RVirtualMethod method) {
        ...
        return methodName.startsWith(TEST_METHOD_NAME_PREFIX)
               && methodName.length() > TEST_METHOD_NAME_PREFIX.length()
               && !(method instanceof RVirtualSingletonMethod);
    }
     ...
     */
    public static boolean checkForAnotherTestCases(@Nullable final RContainer currentContainer,
                                                   @NotNull final RFile rFile) {
