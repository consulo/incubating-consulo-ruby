...
public class ConsoleRunner {
     ...
     */
    private ConsoleRunner(@NotNull final Project project,
...
// Runner creating
        ...
        final RunContentDescriptorFactory factory = myDescriptorFactory == null
                ? RunContentDescriptorFactory.DEFAULT
                : myDescriptorFactory;        
        final RunContentDescriptor myDescriptor = factory.createDesc(myConsoleView, myProcessHandler,
                        new ConsolePanel(myConsoleView, toolbarActions, userActions),
                        myConsoleTitle);
...
// showing run content
        ExecutionManager.getInstance(myProject).getContentManager()
                .showRunContent(defaultRunner, myDescriptor);
    }
...
// create runner
        IdeaInternalUtil.runInEventDispatchThread(new Runnable() {
            public void run() {
                ...
                final ConsoleRunner runner = new ConsoleRunner(project, processListener, consoleFilters,
                                                                ...
                                                                workingDir, provider, descriptorFactory);
    ...
    private class RerunAction extends AnAction {
        ...
        public RerunAction(final ConsoleView consoleView, Runnable rerun) {
            super(RBundle.message("action.rerun"),
                  RBundle.message("action.rerun"),
                  IconLoader.getIcon("/actions/refreshUsages.png"));

            registerCustomShortcutSet(CommonShortcuts.getRerun(),
    ...
    private class ShowCmdLine extends AnAction {
        ...
        public ShowCmdLine() {
            super(RBundle.message("action.consolerunner.edit.cmdline.text"),
                  RBundle.message("action.consolerunner.edit.cmdline.description"),
