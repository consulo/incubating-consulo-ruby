...
class SymbolCoreUtil {
    ...
    public static Symbol find(@NotNull final FileSymbol fileSymbol,
                              @NotNull Symbol anchorSymbol,
...
// if still no first element of path found, we just create it in local namespace!
    ...
    @NotNull
    public static Symbol create(@NotNull final FileSymbol fileSymbol,
                                @NotNull Symbol anchorSymbol,
                                @NotNull final List<String> path,
                                final boolean global,
                                final Type newType,
    ...
    @NotNull
    private  static Symbol findOrCreateUndef(@NotNull final FileSymbol fileSymbol,
                                             @NotNull Symbol anchorSymbol,
    ...
    public static Symbol add(@NotNull final FileSymbol fileSymbol,
                             @NotNull final Symbol parent,
