...
public class FileSymbolUtil {
    //TODO Oleg, should "myJUnitFileSymbolCache" be used anywhere?
    private static final Map<String, FileSymbol> myJUnitFileSymbolCache = new HashMap<String, FileSymbol>();
     ...
     */
    @Nullable
    public static FileSymbol getFileSymbol(@NotNull final RVirtualFile rVFile,
                                           final boolean isRubyTestMode) {
        ...
        final FileSymbol fileSymbol = SymbolCacheUtil.getFileSymbol(
                SymbolsCache.getInstance(project).getModifiableCachedSymbol(FileSymbolType.MODIFIABLE, url, module, sdk, jrubyEnabled));
...
// Nullable safe operations
    ...
    public static void process(@Nullable final FileSymbol fileSymbol, 
