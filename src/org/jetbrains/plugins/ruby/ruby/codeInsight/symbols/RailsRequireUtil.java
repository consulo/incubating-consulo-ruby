...
import org.jetbrains.plugins.ruby.rails.nameConventions.*;
...
public class RailsRequireUtil {
     ...
     */
    public static void requireRailsFiles(@Nullable final FileSymbol fileSymbol,
                                         @NotNull final RVirtualFile rFile,
...
// Migrations
        if (MigrationsConventions.isMigrationFile(rFile, module) ||
                TestsConventions.isTestFrameworkFile(rFile, module)) {
    ...
    private static void addFilesToFilesymbol(@NotNull final FileSymbol fileSymbol,
                                             @Nullable final String fileUrl,
    ...
    private static void loadAllModels(@NotNull final StandardRailsPaths railsPaths,
                                      @NotNull final List<VirtualFile> files,
                                      @NotNull final VirtualFileManager manager) {
    ...
    public static void loadAllModels(@Nullable final FileSymbol fileSymbol,
                                     @NotNull final Module module) {
        if (fileSymbol == null){
            return;
        }
    ...
    private static void loadAllControllersAndHelpers(@NotNull final StandardRailsPaths railsPaths,
                                                     @NotNull final List<VirtualFile> files,
                                                     @NotNull final VirtualFileManager manager) {
        //controllers
    ...
    public static void loadAllControllersAndHelpers(@Nullable final FileSymbol fileSymbol,
                                                    @NotNull final Module module) {
        if (fileSymbol == null){
            return;
        }
    ...
    private static void loadAllLibs(@NotNull final StandardRailsPaths railsPaths,
                                    @NotNull final List<VirtualFile> files,
                                    @NotNull final VirtualFileManager manager) {
    ...
    public static void loadAllLibs(@Nullable final FileSymbol fileSymbol,
                                   @NotNull final Module module) {
        if (fileSymbol == null){
            return;
        }
    ...
    private static void loadAllVendorsLibsWithoutEdgeRails(@NotNull final StandardRailsPaths railsPaths,
                                       @NotNull final List<VirtualFile> files,
                                       @NotNull final VirtualFileManager manager) {
    ...
    private static void addPluginsAndVendorPackagesLibFilesWithoutEdgeRails(final VirtualFile rootDir,
                                                           final HashSet<VirtualFile> set,
                                                           @NotNull final String edgeRailsUrl) {
    ...
    public static void loadAllVendorsLibsWithoutEdgeRails(@Nullable final FileSymbol fileSymbol,
                                                          @NotNull final Module module) {
        if (fileSymbol == null){
            return;
        }
    ...
    private static void loadHelperForController(final Module module,
                                                final List<VirtualFile> files,
                                                final VirtualFileManager manager,
                                                final VirtualFile controllerVFile,
                                                final String controllerDirUrl) {
    ...
    private static void addIfNotNull(@NotNull final List<VirtualFile> files,
    ...
    public static void loadBuiltInHelpers(@Nullable final FileSymbol fileSymbol,
    ...
    public static void loadDBAdapters(@Nullable final FileSymbol fileSymbol,
                                      @NotNull final InterpretationMode mode) {
        if (fileSymbol == null){
            return;
        }
    ...
    public static void loadCoreExtentions(@Nullable final FileSymbol fileSymbol,
                                          @NotNull final InterpretationMode mode) {
        if (fileSymbol == null){
            return;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    @Nullable
    public static FileSymbolType getRailsLayerType(@NotNull final RVirtualFile file,
                                                   @NotNull final Module module) {
        // Controller
        ...
        if (HelpersConventions.isHelperFile(file, module) ||
                ViewsConventions.isRHTMLOrRJSViewFile(file, module)) {
            return FileSymbolType.MODELS_LAYER;
        }
        // Model or Migration
        if (ModelsConventions.isModelFile(file, module) ||
                MigrationsConventions.isMigrationFile(file, module)) {
    ...
    public static void addRailsLoadPath(@Nullable final FileSymbol fileSymbol,
                                        @NotNull final Module module) {
        if (fileSymbol == null){
            return;
        }
    ...
    private static void addUrlIfNotNull(@NotNull final List<String> list,
                                        @Nullable final VirtualFile file) {
        if (file != null) {
    ...
    private static void addRelativeDirsUnderRoot(@NotNull final List<String> list,
    ...
    private static void addAdditionalLoadPathLibsRoots(@NotNull final List<String> list,
                                                       @Nullable final VirtualFile root) {
        if (root != null){
