...
public class RailsSymbolUtil {
     ...
     */
    @NotNull
    public static Children getRailsSpecificSymbols(@NotNull final FileSymbol fileSymbol,
     ...
     */
    @Nullable
    public static Symbol findRailsSpecificSymbol(@NotNull final FileSymbol fileSymbol,
                                                 @NotNull final Symbol symbol,
                                                 @NotNull final String name,
                                                 @NotNull final Context context,
                                                 @NotNull final TypeSet typeSet) {
    ...
    @NotNull
    private static Children getRailsSymbols(@NotNull final FileSymbol fileSymbol,
                                            @NotNull final Symbol symbol,
                                            @NotNull final Context context,
                                            final boolean forceShowAll) {
...
// TODO: models handling
     ...
     */
    @NotNull
    private static Children getSymbolsForController(@NotNull final FileSymbol fileSymbol,
                                                    @NotNull final Symbol symbol,
                                                    @NotNull final Context context) {
...
// ApplicationController
     ...
     */
    @NotNull
    private static Children getSymbolsForHelper(@NotNull final FileSymbol fileSymbol,
                                                @NotNull final Symbol symbol,
...
// own controller
    ...
    private static Children getSymbolsForView(@NotNull final FileSymbol fileSymbol,
                                              @NotNull final Context context,
                                              @NotNull final VirtualFile viewFile,
    ...
    private static void addOwnControllerElements(@NotNull final FileSymbol fileSymbol,
                                                 @NotNull final Context context,
                                                 @NotNull final Children children,
                                                 @NotNull final Symbol controllerSymbol) {
    ...
    private static void addApplicationHelper(@NotNull final FileSymbol fileSymbol,
                                             @NotNull final Children children,
                                             @NotNull final Context context) {
    ...
    private static void addApplicationController(@NotNull final FileSymbol fileSymbol,
                                                 @NotNull final Children children,
                                                 @NotNull final Context context) {
    ...
    private static void addBuiltinHelpers(@NotNull final FileSymbol fileSymbol,
                                          @NotNull final Children children,
                                          @NotNull final Context context) {
