...
public class FileSymbol {
    ...
    public FileSymbol(@Nullable final FileSymbol baseFileSymbol,
                      @NotNull final Project project,
                      final boolean jrubyEnabled,
                      @NotNull final RubyFilesCache... caches) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void addChild(@NotNull final Symbol parent,
                         @NotNull final Symbol child) {
    ...
    public void addPrototype(@NotNull final Symbol symbol,
    ...
    Children getChildren(@NotNull final Symbol symbol) {
        ...
        return myChildren != null ? myChildren :
                myBaseFileSymbol != null ? myBaseFileSymbol.getChildren(symbol) : Children.EMPTY_CHILDREN;
    }

    @NotNull
    Prototypes getVirtualPrototypes(@NotNull final Symbol symbol) {
        final Prototypes myPrototypes = myPrototypesMap.get(symbol);
        return myPrototypes != null ? myPrototypes :
                myBaseFileSymbol != null ? myBaseFileSymbol.getVirtualPrototypes(symbol) : Prototypes.EMPTY_PROTOTYPES;
    }

    @Nullable
    RVirtualElement getLastVirualPrototype(@NotNull final Symbol symbol) {
        final Prototypes myPrototypes = myPrototypesMap.get(symbol);
        return myPrototypes != null ? myPrototypes.getLast() :
                myBaseFileSymbol != null ? myBaseFileSymbol.getLastVirualPrototype(symbol) : null;
    }
    ...
    public void process(@NotNull final String url,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public Symbol getSymbolForContainer(@Nullable final RVirtualContainer container) {
        ...
        return symbol != null ? symbol :
                myBaseFileSymbol != null ? myBaseFileSymbol.getSymbolForContainer(container) : null;
    }
