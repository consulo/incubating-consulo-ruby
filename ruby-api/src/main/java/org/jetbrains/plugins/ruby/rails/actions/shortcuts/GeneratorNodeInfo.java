...
public class GeneratorNodeInfo extends NodeInfo<SerializableGenerator>
{
	...
	private GeneratorNodeInfo(final Image icon, final SerializableGenerator generator, final boolean isGroup)
	{
		this(icon, icon, generator, isGroup);
	}

	private GeneratorNodeInfo(final Image openIcon, final Image closedIcon, final SerializableGenerator generator, final boolean isGroup)
	{
