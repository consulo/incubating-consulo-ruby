...
public abstract class AbstractRubyRunConfigurationeExternalizer extends SettingsExternalizer
{
	...
	@NonNls
	private static final String SHOULD_USE_SDK = "SHOULD_USE_SDK";
	@NonNls
	private static final String ALTERN_SDK_NAME = "ALTERN_SDK_NAME";


	@NonNls
	public static final String PASS_PARENT_ENVS = "myPassParentEnvs";
