...
public class EXPR implements RubyTokenTypes
{
	...
	public static final TokenSet INDICATOR_TOKENS = TokenSet.create(tEXCLAMATION, kNOT, kRETURN, kBREAK, kNEXT, kYIELD, kSUPER, kDEFINED);
...
*/
	...
	private static IElementType parseOrWithLeadAnd(final RBuilder builder, final RMarker marker, final IElementType result)
	{
		...
		return BinaryExprParsing.parseWithLeadOperand(builder, marker, result, parsingMethod, ErrorMsg.EXPRESSION_EXPECTED_MESSAGE, kOR, RubyElementTypes.BOOL_BINARY_EXPRESSION);
	}
	...
	private static IElementType parseAndWithLeadNot(final RBuilder builder, final RMarker marker, final IElementType result)
	{
		...
		return BinaryExprParsing.parseWithLeadOperand(builder, marker, result, parsingMethod, ErrorMsg.EXPRESSION_EXPECTED_MESSAGE, kAND, RubyElementTypes.BOOL_BINARY_EXPRESSION);
	}
	...
	*/
	...
	{
		return parseOrWithLeadAnd(builder, marker.precede(), parseAndWithLeadNot(builder, marker.precede(), parseNotWithLeadSingleExpr(builder, marker.precede(), parseSingleExprWithLeadPRIMARY(builder, marker, result))));
