...
public class ModelsConventions {
    ...
    public static boolean isModelFile(@Nonnull final RFile rFile, @Nullable final Module module) {
    ...
    public static boolean isModelClass(@Nullable final RClass rClass, @Nonnull final Module module) {
