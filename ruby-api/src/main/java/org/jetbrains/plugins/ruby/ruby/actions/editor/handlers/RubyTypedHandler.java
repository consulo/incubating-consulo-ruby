...
public class RubyTypedHandler implements TypedActionHandler, RubyTokenTypes
{
	...
	private static final TokenSet INSERT_QUOTE_OR_BRACE_BEFORE = TokenSet.orSet(BNF.tBINARY_OPS,

			TokenSet.create(tDOT, tDOT2, tDOT3,

					tCOMMA,

					tCOLON, tCOLON2, tCOLON3,

					tQUESTION, tEXCLAMATION,

					tWHITE_SPACE, tEOL,

					tRPAREN, tRBRACE, tRBRACK,
