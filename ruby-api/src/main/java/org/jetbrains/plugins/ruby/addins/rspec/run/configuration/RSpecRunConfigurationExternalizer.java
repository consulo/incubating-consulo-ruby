...
public class RSpecRunConfigurationExternalizer extends AbstractRubyRunConfigurationeExternalizer
{
	...
	@NonNls
	private static final String USE_COLOURED_OUTPUT_ENABLED = "USE_COLOURED_OUTPUT_ENABLED";
	@NonNls
	private static final String RUN_SPECS_SEPARATELY = "RUN_SPECS_SEPARATELY";
	@NonNls
	...
	public void readExternal(final RSpecRunConfiguration config, final Element elem)
	{
		...
		if(type_value != null)
		{
			config.setTestType(Enum.valueOf(RTestsRunConfiguration.TestType.class, type_value));
		}
