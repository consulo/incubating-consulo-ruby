=begin
 ...
 Created on Fri Dec 07 13:50:14 +0300 2007 by IntelliJ IDEA Ruby Plugin.
...
require 'uri'
require 'precision'
require 'zerodivisionerror'
require 'matchingdata'
require 'regexperror'
require 'net'
require 'symbol'
require 'ioerror'
...
require 'integer'
require 'file'
require 'argumenterror'
require 'nomemoryerror'
require 'class'
require 'range'
require 'parsedate'
require 'udpsocket'
...
require 'threaderror'
require 'rangeerror'
require 'floatdomainerror'
require 'signalexception'
require 'loaderror'
require 'fcntl'
require 'localjumperror'
require 'zlib'
require 'forwardable'
require 'float'
require 'indexerror'
require 'gem'
require 'fixnum'
require 'systemcallerror'
require 'falseclass'
require 'systemstackerror'
require 'systemexit'
require 'math'
require 'rbconfig'
require 'nameerror'
require 'nomethoderror'
require 'thread'
require 'socket'
require 'date'
require 'datetime'
...
require 'socketerror'
require 'string'
require 'unboundmethod'
require 'conditionvariable'
require 'bignum'
require 'proc'
require 'struct'
require 'data'
