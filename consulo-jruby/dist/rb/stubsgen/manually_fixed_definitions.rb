...
# This file uses content from the book "Programming Ruby - The Pragmatic Programmer's Guide"
...
module Generators
    class RBGenerator
        ...
        MANUALLY_PATCHED_CONSTANTS = {
                ...
                "object.rb#ENV" => ["A hash-like object containing current environment variables.", "= Object.new #{VALUE_UNKNOWN_COMMENT}"],
                ...
                "object.rb#RUBY_PLATFORM" => ["The identiÞer string of the current ruby platform. ", "= \"\" #{VALUE_UNKNOWN_COMMENT}"],
                ...
                "object.rb#IPsocket" => ["Obsolete.", VALUE_UNKNOWN],
                "object.rb#TCPsocket" => ["Obsolete.", VALUE_UNKNOWN],
                "object.rb#SOCKSsocket" => ["Obsolete.", VALUE_UNKNOWN],
                "object.rb#TCPserver" => ["Obsolete.", VALUE_UNKNOWN],
                "object.rb#UDPsocket" => ["Obsolete.", VALUE_UNKNOWN],
                "object.rb#UNIXsocket" => ["Obsolete.", VALUE_UNKNOWN],
                "object.rb#UNIXserver" => ["Obsolete.", VALUE_UNKNOWN]
        }
        ...
        MANUALLY_PATCHED_CALL_SEQ_MULTIDEF_VARINATS = {
        ...
        MANUALLY_PATCHED_CALL_SEQ_SINGLEDEF_VARINATS = {
             ...
             #io.rb
                ...
                "read.ios.read([length [, buffer]])    => string, buffer, or nil" => "(length, *buffer)",
             ...
             #kernel.rb
                ...
                "method_missing.obj.method_missing(symbol [, *args] )   => resul" => "(symbol, *args)",
             ...
             #stringio.rb
                ...
                "read.strio.read([length [, buffer]])    -> string, buffer, or nil" => "(length, *buffer)",
