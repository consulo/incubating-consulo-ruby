...
public class RubyEditorActionsManager
{
	...
	{
		EditorActionHandler myHandler = new RubyEnterHandler(manager.getActionHandler(IdeActions.ACTION_EDITOR_ENTER));
	...
	{
		EditorActionHandler myHandler = new RubyBackspaceHandler(manager.getActionHandler(IdeActions.ACTION_EDITOR_BACKSPACE));
	...
	public static TypedActionHandler registerRubyTypedActionHandler(EditorActionManager manager)
	{
		...
		TypedActionHandler myHandler = new RubyTypedHandler(originalTypedAction.getHandler());
