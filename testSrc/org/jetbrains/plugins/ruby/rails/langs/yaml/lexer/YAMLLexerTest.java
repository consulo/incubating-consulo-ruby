...
package org.jetbrains.plugins.ruby.rails.langs.yaml.lexer;
...
public class YAMLLexerTest extends LexerTestCase {
    ...
    @NonNls
    private static final String DATA_PATH = PathUtil.getDataPath(YAMLLexerTest.class);

    public YAMLLexerTest() {
        super(DATA_PATH);
    }

    protected void setUp() {
       super.setUp();
       setLexer(new YAMLLexer());
   }

    public static Test suite() {
        return new YAMLLexerTest();
    }
