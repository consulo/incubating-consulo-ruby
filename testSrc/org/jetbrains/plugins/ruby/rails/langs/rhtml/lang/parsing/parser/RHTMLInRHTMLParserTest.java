 ...
 * @date: Aug 30, 2007
 */
public class RHTMLInRHTMLParserTest extends AbstractRHTMLParserTest {
    @NonNls private static final String DATA_PATH =
            PathUtil.getDataPath(AbstractRHTMLParserTest.class) + "/rhtml_root";

    public RHTMLInRHTMLParserTest() {
        super(DATA_PATH);
    }
    ...
    public static Test suite() {
        return new RHTMLInRHTMLParserTest();
    }
}