 ...
 * @date: Nov 15, 2006
 */
public class LineCommenterTest extends BaseEditorActionTestCase {
    @NonNls private static final String DATA_PATH = PathUtil.getDataPath(LineCommenterTest.class);

    public LineCommenterTest() {
        super(DATA_PATH);
    }
