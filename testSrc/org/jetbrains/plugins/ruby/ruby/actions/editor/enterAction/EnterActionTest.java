...
package org.jetbrains.plugins.ruby.ruby.actions.editor.enterAction;
 ...
 * Date: 22.08.2006
 */
public class EnterActionTest extends EditorActionTestCase {
    @NonNls private static final String DATA_PATH = PathUtil.getDataPath(EnterActionTest.class);
    ...
    protected EditorActionHandler createHandler() {
        return RubyEditorActionsManager.registerRubyEnterActionHandler(EditorActionManager.getInstance());
    }
